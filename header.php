...
<div id="loader">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/logo1.png" alt="" style="height: 51px;"></a> </div>
      <div class="head-info">
        <ul>
          <li> <i class="fa fa-phone"></i>
            <p>01 448873, 01 456674<br>
              01 4332421 H</p>
          </li>
          <li> <i class="fa fa-envelope-o"></i>
            <p>PandS_HS@gmail.com<br>
            PandS_HSinfo@gmail.com</p>
          </li>
          <li> <i class="fa fa-map-marker"></i>
            <p>Gokarneshwor 08 ,Kathmandu<br>
             Jorpati </p>
          </li>
        </ul>
      </div>
