      ...
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="images/Medicity.jpg"  alt="slider"  data-bgposition=" center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endspeed="300" 
                style="z-index: 6; font-size:40px; color:white; font-weight:500; white-space: nowrap;">We care about your health </div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7;  font-size:22px; color:white; font-weight:500; max-width: auto; max-height: auto; white-space: nowrap;">Best Hospitality Services in your town</div>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="images/doctors.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
              ...
              <div class="text-sec">
                ...
                <ul class="row">
                  <li class="col-sm-6">
                    ...
                    <p>For emergency cases we provide the doctor who is good in every field,
                       And for further checkup case related doctors will arrive shortly  </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> QUALIFIED DOCTORS</h6>
                    <p>PandS Hospital have the best doctors from all the Department,
                        and they have gained excellent reviews and patient's trust </p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> ONLINE APPOINTMENT</h6>
                    <p>You can either contact us or login to our website for ONLINE APPOINTMENT,
                        Visiting hospital will be better if you,re new.</p>
                  </li>
                  <li class="col-sm-6">
                    <h6> <i class="lnr  lnr-checkmark-circle"></i> FREE MEDICAL COUNSELING</h6>
                    <p>We will be very happy to help you as a service giver,
                      So, you can also contact us to share the details of your problems </p>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="timing"> <i class="lnr lnr-clock"></i>
                <ul>
                  ...
                  <li> Tuesday <span>8.00 - 6.00pm</span></li>
                  <li> Wednesday <span>8.00 - 6.00pm</span></li>
                  <li> Thursday <span>8.00 - 6.00pm</span></li>
                  <li> Friday <span>8.00 - 6.00pm</span></li>
                  <li> Saturday <span>8.00 - 4.00pm</span></li>
                  <li> Sunday <span>8.00 - 6.00pm</span></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <section class="p-t-b-150">
      <div class="container"> 
        ...
        <div class="heading-block">
          <h2>Our Services</h2>
          <hr>
          <span>We help our patients to be healthy and be well known about the problems they had and its solutions. We provide additional discounts for economically weak patients and childrens</span> </div>
            ...
            <div class="col-md-4">
              <article>
                ...
                <div class="media-body">
                  ...
                  <p>Case related doctors of this department will be very helpful for your betterment.</p>
                </div>
              </article>
            </div>
