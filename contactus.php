...
{  
	...
	sendmail("yashikachinz19Magicaltamang077@gmail.com","Mail from Appoint My Doctor",$message);
...
<div class="wrapper col4">
  <div id="container">
    <h6>Our Address</h6>
    <p>
Online Appointment Management System , Nepal<br />

<strong>tel</strong>:01 441300<br />

<strong>Email ID</strong>: Samratbhandari07@gmail.com</p>
...
function sendmail($toaddress,$subject,$message)
{
	...
	$mail->Host = 'mail.PandS.in';  // Specify main and backup SMTP servers
	$mail->SMTPAuth = true;                               // Enable SMTP authentication
	$mail->Username = 'sendmail@PandScompany.in';                 // SMTP username
	$mail->Password = 'q1w2e3r4/';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to
	
	$mail->From = 'sendmail@PandScompany.in';
	$mail->FromName = 'Web Mall';
	$mail->addAddress($toaddress, 'Joe User');     // Add a recipient
	$mail->addAddress($toaddress);               // Name is optional
	$mail->addReplyTo('sendmail@PandScompany.in', 'Information');
